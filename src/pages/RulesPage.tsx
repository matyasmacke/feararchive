      ...
      <div className="mx-auto max-w-3xl">
        <div className="mb-8 flex items-center gap-4">
          ...
          <div>
            ...
            <p className="mt-1 text-gray-400">Guidelines for The Fear Archive storytelling community</p>
          </div>
        </div>
        ...
        >
          <FormattedContent content={rules} className="text-sm text-gray-300 sm:text-base" />
        </div>
