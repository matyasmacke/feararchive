...
export function GdprPage() {
  const rules = getSettings().gdprText;
    ...
    return (
      <p key={i} className="text-sm sm:text-base text-gray-300 leading-relaxed">
        {parts.map((part, j) => {
          if (j % 2 === 1) {
            return (
              <strong key={j} className="text-purple-300 font-semibold">
                {part}
              </strong>
            );
          }
          // plain text → split on pipe urls or plain urls
          return part
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            ...
            <p className="text-gray-400 mt-1">General Data Protection Regulation (GDPR) Compliance Statement</p>
          </div>
        </div>
